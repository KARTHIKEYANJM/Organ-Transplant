...
#defining the root and home pages with POST and GET methods
...
def home():
    if not session.get('login'):
        ...
        if session.get('isAdmin') :
            ...
            return home_student()
#defining the login page with POST and GET methods
...
#defining the show_update_detail page with POST and GET method
...
#defining the search_detail page with POST and GET method
...
#defining the add_User page with POST and GET method
...
#defining the add_User_phone_no with POST and GET method
...
#defining the add_Patient with POST and GET method
...
#defining the add_Donor with POST and GET method
...
#defining the add_Doctor with POST and GET method
...
#defining the add_Doctor_phone_no with POST and GET method
...
#defining the add_Organ_available with POST and GET method
...
#defining the add_Organization with POST and GET method
...
#defining the add_Organization_phone_no with POST and GET method
...
#defining the add_Organization_head with POST and GET method
...
#defining the add_Transaction with POST and GET method
...
#------------------------Update details-------------------------------------		#-------------------------------------------------------------
#defining the update_user_page with POST and GET method
...
#defining the update_user_details with POST and GET method
...
#defining the update_patient_page with POST and GET method
...
#defining the update_patient_details with POST and GET method
...
def update_patient_details():
    ...
    print(qry2)
    return render_template("show_detail.html",res = res,fields=fields,not_found = False)
#defining the update_donor_page with POST and GET method
...
#defining the update_donor_details with POST and GET method
...
def update_donor_details():
    ...
    print(qry2)
    return render_template("show_detail.html",res = res,fields=fields,not_found = False)
#defining the update_doctor_page with POST and GET method
...
#defining the update_doctor_details with POST and GET method
...
def update_doctor_details():
    ...
    res = mycursor.fetchone()
    return render_template("show_detail.html",res = res,fields=fields,not_found = False)
#defining the update_organization_page with POST and GET method
...
#defining the update_organization_details with POST and GET method
...
#----------------------------Logout-----------------------------------------
#defining the logout with POST and GET method
...
#defining the search_User_details with POST and GET method
...
#defining the search_Patient_details with POST and GET method
...
def search_Patient_details():
    ...
    return render_template('/search_and_show_list.html',res=res,fields=fields)
#defining the search_Donor_details with POST and GET method
...
def search_Donor_details():
    ...
    return render_template('/search_and_show_list.html',res=res,fields=fields)
#defining the search_Organ_details with POST and GET method
...
def search_Organ_details():
    ...
    return render_template('/search_and_show_list.html',res=res,fields=fields)
#defining the search_Organization_details with POST and GET method
...
def search_Organization_details():
    ...
    return render_template('/search_and_show_list.html',res=res,fields=fields)
#defining the search_Organization_head_details with POST and GET method
...
def search_Organization_head_details():
    ...
    return render_template('/search_and_show_list.html',res=res,fields=fields)
#defining the search_Doctor_details with POST and GET method
...
def search_Doctor_details():
    ...
    return render_template('/search_and_show_list.html',res=res,fields=fields)
#defining the search_Transaction with POST and GET method
...
def search_Transaction_details():
    ...
    res = mycursor.fetchall()
    return render_template('/search_and_show_list.html',res=res,fields=fields)
#defining the search_log with POST and GET method
...
#defining the del_user with POST and GET method
...
def del_hostel():
    ...
    mydb.commit()
    return redirect( url_for('home') )
#defining the del_patient with POST and GET method
...
def del_patient():
    ...
    mydb.commit()
    return redirect( url_for('home') )
#defining the del_donor with POST and GET method
...
#defining the del_doctor with POST and GET method
...
#defining the del_organization with POST and GET method
...
#defining the del_organization_head with POST and GET method
...
#defining the statistics with POST and GET method
...
def stats():
    ...
    for organ in stats_donor:
        A.append(organ[0])
        B.append(organ[1])
    #Here we use matplotlib.pyplot as our statistics tool to generate the graphs and visualization
    plt.pie(B, labels = A)
